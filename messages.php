<?php // Example 26-11: messages.php
  ...
  if ($view != "")
  {
    ...
    echo <<<_END
      ...
      <input class='form-control btn btn-primary' type='submit' value='Post Message'></form><br>
_END;
  ...
  echo "<br><a class='button btn btn-success' href='messages.php?view=$view'>Refresh messages</a>";
?>
